...
<br>
<li>Software Básico
<li>Lógica e Programação
<li>Redes e Segurança
<li>Banco de Dados PostgreSQL
<li>Administração de Sistemas de Informação
<li>Projeto de Software e Segurança da Informação
<li>Implementação e Testes de Projetos de Software
<li>Governaça de TI
<li>Análise e Implementação de Software
<li>Padrões de Projetos Orientados a Objetos 
